                ...
                <!--begin::Create Tag 2-->
                  ...
                  <form action="{{ route('admin.tag.update', $tag->id) }}" method="POST">
                    ...
                    <div class="form-group mb-4">
                      ...
                      <input type="text" class="form-control" name="title" id="tagName" value ="{{ $tag->title }}">
                      @error('title')
                    ...
                    <div class="form-group">
                      <button type="submit" class="btn btn-primary form-control" value="create">Update Tag</button>
                    </div>
